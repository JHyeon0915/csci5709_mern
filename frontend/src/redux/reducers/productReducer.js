...
const productReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case CREATE_PRODUCT_REQUEST:
            return { ...state, creatLoding: true, error: null };
        case CREATE_PRODUCT_SUCCESS:
            return { ...state, creatLoding: false, items: [...state.items, action.payload] };
        case CREATE_PRODUCT_FAILURE:
            return { ...state, creatLoding: false, error: action.payload };
